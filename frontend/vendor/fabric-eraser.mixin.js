  ...
  fabric.EraserBrush = fabric.util.createClass(
    ...
    /** @lends fabric.EraserBrush.prototype */ {
      ...
      _render: function () {
        ...
        var previousWidth = this.width || 0;
        var previousStrokeLineCap = this.strokeLineCap;
        var previousStrokeLineJoin = this.strokeLineJoin;
        this.width = previousWidth + 1;
        ...
        try {
          ...
          this.strokeLineCap = previousStrokeLineCap;
          this.strokeLineJoin = previousStrokeLineJoin;
        }
        ctx.save();
